...
/**
 * Register strategy for phone and password credentials.
 * Requires a verification code to confirm phone ownership before creating the account.
 */
@Slf4j
@Component
public class PhonePasswordRegisterStrategy extends AbstractRegisterStrategyImpl {
