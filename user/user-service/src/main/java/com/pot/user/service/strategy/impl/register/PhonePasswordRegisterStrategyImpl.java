...
public class PhonePasswordRegisterStrategyImpl extends AbstractRegisterStrategyImpl<PhonePasswordRegisterRequest> {
    ...
    public PhonePasswordRegisterStrategyImpl(UserService userService, VerificationCodeStrategyFactory verificationCodeStrategyFactory, PasswordUtils passwordUtils, IdUtils idUtils) {
